...
- [HR Onboarding Agent (GHCP)](./01-scenarios/HR-Onboarding-Agent-GHCP/1.Overview.md) - GitHub Copilot harness adaptation with reusable Agent Skills, a standard-vs-GHCP comparison, and workflow-based HR email handling.
