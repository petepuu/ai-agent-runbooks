...
- [HR Onboarding Agent (GHCP)](./01-scenarios/HR-Onboarding-Agent-GHCP/1.Overview.md) - Copilot Studio GitHub Copilot harness adaptation with four runtime skill definitions, grounded HR guidance, checklists and draft-only email assistance; optional reviewed sending requires backend implementation.
...
- [Employee Self-Service Agent (GHCP)](./01-scenarios/Employee-Self-Service-Agent-GHCP/1.Overview.md) - Custom GitHub Copilot harness adaptation with four reusable Skills, grounded HR/IT guidance, catalog routing, and optional authorized live request status.
