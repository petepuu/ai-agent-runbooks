...
- [HR Onboarding Agent (GHCP)](./01-scenarios/HR-Onboarding-Agent-GHCP/1.Overview.md) - GitHub Copilot harness agent with reusable Agent Skills, grounded HR guidance, onboarding checklists, and workflow-based email handling.
