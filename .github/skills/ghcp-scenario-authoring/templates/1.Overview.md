...
> Source: {{SOURCE_LINK}}, revision {{ACTUAL_REVISION}}.
> Target: Microsoft Copilot Studio, GitHub Copilot harness.
> Authored: {{DATE}}. Status: {{IMPLEMENTATION_STATUS}}.
> Scope changes: {{SCOPE_CHANGES}}. Original scenario remains unchanged.
...
{{BUSINESS_CONTEXT_AND_ACCURATE_SOURCE_HARNESS}}
...
{{GHCP_APPROACH_AND_WHY_A_SEPARATE_AGENT}}
...
provenance, asset disposition, official-source checks and owner-assigned gates in
