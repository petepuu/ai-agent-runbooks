...
| [HR-Onboarding-Agent-GHCP](./HR-Onboarding-Agent-GHCP/1.Overview.md) | Employee Self-Service (HR) | Four runtime skill definitions for grounded HR answers, checklists, email drafts and an OFF reviewed-email extension with proposed backend contracts. | Microsoft Copilot Studio, GitHub Copilot harness, ServiceNow knowledge | Authored; tenant validation required |
