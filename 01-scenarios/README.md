...
| [HR-Onboarding-Agent-GHCP](./HR-Onboarding-Agent-GHCP/1.Overview.md) | Employee Self-Service (HR) | Four runtime skills for all-employee HR guidance, onboarding checklists, chat drafts and intended autonomous Workflows replies without per-message approval; email remains OFF pending invocation, backend and release gates. | Microsoft Copilot Studio, GitHub Copilot harness, Workflows, Outlook, ServiceNow knowledge | 📝 Draft; tenant validation required |
