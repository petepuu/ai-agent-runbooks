...
├── 📂 Employee-Self-Service-Agent-GHCP/    ← 📝 Draft
│   ├── 📂 0.Resources/
│   ├── 1.Overview.md
│   ├── 2.Architecture.md
│   ├── 3.Runbook.md
...
│   ├── 3.Runbook.md
│   └── 4.Sample-prompts.md
├── 📂 HR-Onboarding-Agent-GHCP/                ← Authored; tenant validation required
│   ├── 📂 0.Resources/                         ← Capability matrix and runtime skills
│   ├── 1.Overview.md
│   ├── 2.Architecture.md
│   ├── 3.Runbook.md
│   └── 4.Sample-prompts.md
...
| [Employee Self-Service (GHCP)](./Employee-Self-Service-Agent-GHCP/1.Overview.md) | Employee Experience (HR + IT front door) | Four runtime skills for published HR/IT guidance and exact request navigation, with a proposed/OFF caller-authorized own IT request status contract. No writes or personal HR records. | Microsoft Copilot Studio, GitHub Copilot harness, SharePoint, ServiceNow knowledge/catalog | 📝 Draft |
...
| [HR-Onboarding-Agent-GHCP](./HR-Onboarding-Agent-GHCP/1.Overview.md) | Employee Self-Service (HR) | All four runtime skills are standard: all-employee HR guidance, onboarding as a subset, draft-only chat and autonomous HR shared-mailbox Workflows replies without per-message approval. Operators configure and test dependencies during setup. | Microsoft Copilot Studio, GitHub Copilot harness, Workflows, Outlook, ServiceNow knowledge | 📝 Draft; tenant validation required |
