...
| [HR-Onboarding-Agent-GHCP](./HR-Onboarding-Agent-GHCP/1.Overview.md) | Employee Self-Service (HR) | Normal HR chat, onboarding plans and connected user-mailbox replies with two skills. Outlook sends the agent's HTML without per-message approval; development scope and limitations are documented. | Microsoft Copilot Studio, GitHub Copilot harness, Workflows, Outlook, ServiceNow knowledge | 📝 Draft; tenant validation required |
