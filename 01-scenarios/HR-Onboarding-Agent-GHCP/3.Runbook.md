...
14. In **Build → Model**, confirm that **GPT-5.5 Chat** is selected and **Save**. Verify tenant availability and organizational approval before production use. Leave memory off initially.
