...
Use [Copilot Studio Workflows](https://learn.microsoft.com/en-us/microsoft-copilot-studio/workflows-experience/flows-overview) and its [Agent node](https://learn.microsoft.com/en-us/microsoft-copilot-studio/workflows-experience/agent-node-workflow), **not a direct standard-harness agent trigger**.

1. Select **Workflows** from the left menu. If the agent has unsaved changes, click **Save and continue**.

> ![Select Workflows and save any unsaved agent changes](0.Resources/Images/062.png)
