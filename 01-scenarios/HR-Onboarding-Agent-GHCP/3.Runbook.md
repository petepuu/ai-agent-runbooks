...
4. After adding, confirm the knowledge source appears under **Build → Knowledge** and record its real connection name. If absent, resolve indexing/access setup rather than choosing broader sources.
5. Keep public websites, broad browsing and personal-record sources out of this configuration. Enforce source-only policy answers with global instructions and negative tests.
