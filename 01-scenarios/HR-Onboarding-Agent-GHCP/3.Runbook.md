...
3. Select **Add skill > Upload a skill** and upload each downloaded Markdown file.
4. Inspect each imported name, description and full instructions, then save. Verify skill selection in Preview with matching and boundary prompts.
