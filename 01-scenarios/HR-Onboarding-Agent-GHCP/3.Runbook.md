...
> ![Open Settings from the three-dot menu in the top-right corner](0.Resources/Images/049.png)
...
> ![Review the primary language and solution before saving the agent](0.Resources/Images/050.png)

13. Click the **Save** icon to create the agent.

> ![Click Save to create the agent](0.Resources/Images/051.png?v=48d8d617)
...
> ![Select Knowledge to add ServiceNow to the agent](0.Resources/Images/052.png)

2. Select **ServiceNow**.

> ![Select ServiceNow as the knowledge source](0.Resources/Images/053.png)

3. Select the ServiceNow connection you created earlier and click **Add**.

> ![Select the ServiceNow connection and click Add](0.Resources/Images/054.png)

4. After adding, confirm the knowledge source appears under **Build → Knowledge**.

> ![ServiceNow knowledge source added under Build > Knowledge](0.Resources/Images/055.png)

5. Save the agent.

> ![Save the agent after adding ServiceNow knowledge](0.Resources/Images/051.png?v=48d8d617)
...
> ![Return to the solution and click Done after creating the agent](0.Resources/Images/062.png)

2. Select **+ New > More > Environment variable**.

> ![Create an environment variable in the solution](0.Resources/Images/063.png)

3. Provide the name **HR Email Address**, select **Data Type > Text**, and click **+ New value**.

> ![Configure the HR Email Address text environment variable](0.Resources/Images/064.png)

4. For testing, provide your own email address and click **Save**.

> ![Set the test email address and save the environment variable](0.Resources/Images/065.png)
...
> ![Open Workflows from the agent's left menu](0.Resources/Images/067.png)
...
> ![Select Workflows from the left menu](0.Resources/Images/067.png)

2. Select **New workflow**.

> ![Create a new workflow](0.Resources/Images/068.png)

3. Select the trigger node to open its settings.

4. Change **Trigger type** to **Connector**.

> ![Change the trigger type to Connector](0.Resources/Images/070.png)

5. Select **Office 365 Outlook**.

> ![Select the Office 365 Outlook connector](0.Resources/Images/069.png)

6. Select **When a new email arrives in a shared mailbox**.

> ![Select the shared-mailbox email trigger](0.Resources/Images/066.png)
