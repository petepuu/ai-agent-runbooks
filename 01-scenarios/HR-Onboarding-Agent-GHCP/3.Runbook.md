...
1. Download [hr-email-reply.md](https://raw.githubusercontent.com/petepuu/ai-agent-runbooks/main/01-scenarios/HR-Onboarding-Agent-GHCP/0.Resources/Skills/hr-email-reply.md) and [hr-onboarding-checklist.md](https://raw.githubusercontent.com/petepuu/ai-agent-runbooks/main/01-scenarios/HR-Onboarding-Agent-GHCP/0.Resources/Skills/hr-onboarding-checklist.md) from [0.Resources/Skills](0.Resources/Skills). These links open the raw Markdown files. If your browser displays the text instead of downloading it, press **Ctrl+S** and save with the shown `.md` filename.
