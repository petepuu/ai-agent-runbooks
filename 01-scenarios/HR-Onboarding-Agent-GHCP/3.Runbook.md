...
### Step 2-4. Add Suggested Prompts
...
2. Upload both standalone files in [matrix order](0.Resources/Skills/README.md):
   ...
   |---|---|---|
   | 1 | [hr-onboarding-checklist/SKILL.md](0.Resources/Skills/hr-onboarding-checklist/SKILL.md) | Chat-only numbered planning checklist, grouped into phases with placeholders |
