...
2. Select **Greetings & prompts** and add all the prompts below using **+ Add a suggested prompt**.

> ![Select Greetings & prompts and add suggested prompts](0.Resources/Images/088.png?v=77e147050a8b)
...
> **Screenshot to replace — GHCP:** saved suggested prompts, with Onboarding process first.
