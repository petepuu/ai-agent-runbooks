...
> ![Select When a new email arrives](0.Resources/Images/066.png?v=f15bb9d53595)

6. Set **Subject filter** to **HR question**.

> ![Set the Subject filter value to HR question](0.Resources/Images/071.png?v=cb0a2ae6902f)
...
9. Select **An existing agent** → the published **HR Onboarding Agent**. Do not create an inline agent or substitute an unverified Execute Agent connector route. Complete the remaining instructions and skill setup, then republish before testing this node.
10. In **Message**, supply the sanitized inquiry and isolated trusted context and allowed topics from accepted intake. Record exact GHCP target/version, imported skill execution and effective retrieval identity. Keep **Request human assistance when unsure** disabled; exceptions use the fixed HR queue, not email to the connection owner.
