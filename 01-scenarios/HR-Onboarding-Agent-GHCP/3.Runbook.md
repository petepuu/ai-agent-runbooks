...
3. Select the trigger node to open its settings.

4. Change **Trigger type** to **Connector**.

> ![Change the trigger type to Connector](0.Resources/Images/070.png?v=46bfe700fbaa)

5. Select **Office 365 Outlook**.

> ![Select the Office 365 Outlook connector](0.Resources/Images/069.png?v=2ef0ef119cd4)

6. Select **When a new email arrives in a shared mailbox**.

> ![Select the shared-mailbox email trigger](0.Resources/Images/066.png?v=edac3435379d)

7. Configure the shared-mailbox V2 trigger (`SharedMailboxOnNewEmailV2`). Set its **Original Mailbox Address** and actual folder; verify delegated connection access. A Microsoft 365 group is not a shared mailbox.
8. Set **Include Attachments = No**. Backend intake still checks authoritative attachment metadata; this switch does not reject attached mail. Validate transport authenticity, employee mapping, stable message identity, rate/loop suppression and full request coverage through `AcceptHrEmailEvent`.
9. Add **Agent** from the designer's Add panel → **An existing agent** → select the published **HR Onboarding Agent**. Do not create an inline agent or substitute an unverified Execute Agent connector route.
