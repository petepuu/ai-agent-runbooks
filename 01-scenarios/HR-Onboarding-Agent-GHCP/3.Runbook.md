...
6. **Publish** the agent. It must be published before Step 2-4 so you can select it in the Workflow.
...
### Step 2-3. Add Suggested Prompts
...
### Step 2-4. Add Workflow for autonomous trigger
...
1. Download [hr-email-reply.md](0.Resources/Skills/hr-email-reply.md) and [hr-onboarding-checklist.md](0.Resources/Skills/hr-onboarding-checklist.md) from [0.Resources/Skills](0.Resources/Skills).
