...
This scenario describes an HR onboarding agent that helps employees find applicable company policies, benefits information and first-week guidance. It uses focused skills for the **GitHub Copilot harness in Microsoft Copilot Studio**, not Copilot CLI or a coding agent.
