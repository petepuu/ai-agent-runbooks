...
| Onboarding checklists | `hr-onboarding-checklist` searches configured knowledge before turning general onboarding questions or supplied new-hire details into phased, numbered chat checklists, with placeholders for unknown specifics |
...
- Chat-only onboarding plans informed by configured knowledge, grouped into Before Day 1, Day 1, First Week and First Month, with placeholders rather than invented company details.
