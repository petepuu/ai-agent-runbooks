...
flowchart TD
    ...
    K["M365 Search / Semantic Index<br/>ServiceNow KB articles indexed by Copilot connector<br/>Permission-trimmed evidence"]
    ...
    W["Copilot Studio Workflows<br/>Email trigger / agent call / reply delivery"]
    G["Backend Validation<br/>Current policy and recipient-safe evidence<br/>Server-issued payload authorization"]
    E["Employee Receives Email<br/>Sent by Workflows via Outlook<br/>No per-message approval"]
    ...
    W -->|"Validates response through backend"| G
    G -->|"Authorized result returned to workflow"| W
    W -->|"Sends authorized reply via Outlook"| E
