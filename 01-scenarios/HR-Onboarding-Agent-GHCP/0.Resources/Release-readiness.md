...
Before testing the Agent node, complete the instructions and all four skill imports in [Runbook Steps 2-5 through 2-7](../3.Runbook.md#step-2-5-update-agent-instructions), and publish that configuration to the isolated test scope. Then return here to verify invocation and downstream processing.
