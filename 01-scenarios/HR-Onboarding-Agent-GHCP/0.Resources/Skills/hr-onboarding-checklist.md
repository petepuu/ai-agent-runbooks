...
description: |-
  ...
  Do NOT use for emails — use `hr-servicenow-email-composer` for an email body instead. Do NOT use for
...
- The user wants an email body sent to the new hire or their manager — use `hr-servicenow-email-composer`.
