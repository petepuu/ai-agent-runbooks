...
flowchart TB
    subgraph USER["1. User and Event Layer"]
        ...
        W["HR Email Inquiry<br/>Outlook shared mailbox<br/>Workflows trigger"]
    end
    ...
    subgraph DATA["3. Data and Integration Layer"]
        ...
        D["Workflow Integration<br/>Validate and send via Outlook<br/>HR exception handling"]
    end
    ...
    A -->|"Result returned to workflow"| D

    style U fill:#0078D4,color:#fff,stroke:#005A9E
    style W fill:#0078D4,color:#fff,stroke:#005A9E
...
Workflows handles the email trigger, invokes the agent, and validates and delivers the returned result through its configured integration. The trigger and delivery boxes represent stages of that same workflow. No send tool is exposed to the agent. Chat responses return through Teams or Microsoft 365 Copilot.
