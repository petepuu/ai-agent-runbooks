...
| Skills | Two standalone definitions | Onboarding checklist and formatted HTML workflow reply; ordinary HR answers and chat drafts use global instructions |
...
| Chat reply text | Global instructions | Subject/body and citations only, no separate skill; chat never initiates the trusted email event path |
